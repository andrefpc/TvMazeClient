package com.andrefpc.tvmazeclient.presentation.compose.screen.main
...
import com.andrefpc.tvmazeclient.presentation.compose.screen.main.view.MainView
...
class MainActivity : FragmentActivity() {
    ...
    private fun openShows() {
        appNavigation.navigateTo(this@MainActivity, NavigatorScreen.Shows)
    }
